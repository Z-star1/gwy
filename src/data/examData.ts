...
/** 工作日每日 2 小时安排（周一至周五）——以看技巧/素材/模板为主 */
export const WEEKDAY_SCHEDULE = [
  { day: '周一', xingce: '资料分析技巧：速算与增长概念过一遍', shenlun: '归纳概括：总括词表 + 读 2 段材料练提取', tip: '先吃透方法，再考虑刷题' },
  { day: '周二', xingce: '判断推理：图形/类比/定义方法卡片复盘', shenlun: '精读评论 1 篇，摘 3 条金句进积累本', tip: '素材和词语比盲目刷题更保值' },
  { day: '周三', xingce: '言语：逻辑填空语境类型 + 成语易错表', shenlun: '综合分析：解释/评价结构模板过一遍', tip: '申论结构背熟，考场不慌' },
  { day: '周四', xingce: '资料分析：比重、平均数公式与坑点', shenlun: '提出对策：主体+手段句式，抄 10 条对策词', tip: '对策词要能落到材料问题' },
  { day: '周五', xingce: '数量只看高频模型；常识看法条时政清单', shenlun: '贯彻执行：选一种公文模板默写骨架', tip: '周末留给作文框架和大作文素材' },
];

/** 周末安排（同样 2h/天） */
export const WEEKEND_SCHEDULE = [
  { day: '周六', focus: '行测复盘', content: '薄弱题型技巧重读 1.5h + 整理易错口诀 0.5h', tip: '针对本周最生疏的模块，把方法写进笔记' },
  { day: '周日', focus: '申论主攻', content: '作文/公文模板 1h + 素材库按题型摘抄 1h', tip: '在职党周日务必碰作文框架，工作日很难写完整篇' },
];
...
export const WORKING_TIPS = [
  { title: '通勤碎片时间', content: '看技巧页一个子题型，或背 5 个申论总括词 / 成语' },
  { title: '午休 20 分钟', content: '翻素材库金句，或默写一种公文骨架' },
  { title: '保证睡眠', content: '在职党切忌熬夜，每天 2 小时高效看方法 > 4 小时低效刷题' },
  { title: '周末是主战场', content: '工作日积累词语和模板，周末写提纲或完整练笔' },
  { title: '请假策略', content: '考前 1 周如有年假，建议请 2-3 天集中复盘技巧本和素材本' },
];
